import {
  ...
  const itemsRequestedFromYouTableRows = [
    {
      id: 1,
  ...
  function ItemsRequestedFromYouTableComponent() {
    return (
      <div className="bg-white p-6 shadow rounded-lg">
        <div className="overflow-x-auto">
          <Table>
            ...
            <TableBody>
              {itemsRequestedFromYouTableRows.map((row) => (
                <ItemRequestedFromYouTableRow key={row.id} {...row} />
              ))}
            </TableBody>
          </Table>
        </div>
  ...
  function ItemRequestedFromYouTableRow({ id, itemImage, item, itemDescription, date, user, status, reportType  }) {
    return (
      <TableRow>
  ...
  export default function ItemsRequestedFromYouTable() {
    return (
      <div className="bg-white p-6 shadow rounded-lg">
        <div className="overflow-x-auto">
          <ItemsRequestedFromYouTableComponent />
        </div>
