...
const yourRequestedItemsTableRows = [
  {
    id: 1,
...
function YourRequestedItemsTableComponent() {
  return (
    <div className="bg-white p-6 shadow rounded-lg">
      <div className="overflow-x-auto">
        <Table>
          ...
          <TableBody>
            {yourRequestedItemsTableRows.map((row) => (
              <YourRequestedItemsTableRow key={row.id} {...row} />
            ))}
          </TableBody>
        </Table>
      </div>
...
function YourRequestedItemsTableRow({ id, itemImage, item, itemDescription, date, user, status, reportType  }) {
  return (
    <TableRow>
...
export default function YourRequestedItemsTable() {
  return (
    <div className="bg-white p-6 shadow rounded-lg">
      <div className="overflow-x-auto">
        <YourRequestedItemsTableComponent />
      </div>
